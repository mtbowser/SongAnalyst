...
//        {
//            // ie: res[index++] = curr.data(); curr = curr.next()l o
//            res[index] = (T)curr.data;
//            curr = curr.next();
//            index++;
//
//        }
//        return res;
         String[] butt = new String[5];
         return butt; 
    }
    ...
    /*
     * BE RIGHT BACK private inner DLinkedListIterator
     * class///////////////////////////////
     */
